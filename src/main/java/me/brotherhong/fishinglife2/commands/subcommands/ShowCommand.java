...
import me.brotherhong.fishinglife2.menu.menus.ShowMenu;
...
public class ShowCommand extends SubCommand {
    ...
    public ShowCommand(FishingLife2 plugin) {
        super(plugin);
    }
    ...
    public String getDescription() {
        return "Show all drops of the region.";
    }

    @Override
    public String getUsage() {
        return "/fl show <region>";
    }

    @Override
    public boolean hasPermission(Player p) {
        return p.hasPermission(Permissions.SHOW.getPerm());
    }
    ...
    public void execute(Player p, String[] args) {
        ...
        new ShowMenu(plugin, utility).open();
    }
